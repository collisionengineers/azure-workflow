...
Record when an agent violated available authority, made a false completion/evidence claim, crossed scope or authorization, allowed a defect to escape a required gate, or exposed a reusable workflow gap. Recover or contain the effect first.

## What not to record

Do not record expected red tests, ordinary findings caught by their intended gate, user decisions, external tool failures handled correctly, style preferences, or inferred historical incidents.
